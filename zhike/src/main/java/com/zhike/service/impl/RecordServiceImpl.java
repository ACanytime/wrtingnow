...
import static com.zhike.pojo.table.Tables.NOTE_THING_LOG;
...
public class RecordServiceImpl implements IRecordService {
    ...
    @Override
    public List<NoteThingLog> getRecordList(int userId) throws ServiceException {
        ...
        QueryWrapper wrapper=QueryWrapper.create()
                ...
                .orderBy(NOTE_THING_LOG.TIME.desc());
